    ...
    <div className="flex flex-col h-full">
      <div className="max-w-5xl mx-auto p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 @2xl:grid-cols-2 gap-6">
          ...
          <div className="grid grid-cols-1 @2xl:grid-cols-2 gap-6">
            <div className="bg-window border border-border rounded overflow-hidden order-2 @2xl:order-1">
              <div className="px-4 py-2 bg-surface-hover border-b border-border text-xs uppercase tracking-wide text-text">
                Send a Message
              </div>
              <div className="p-4">
                <ContactForm />
